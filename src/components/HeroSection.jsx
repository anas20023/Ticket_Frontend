...
const HeroSection = () => {
    return (
        ...
        >
            ...
            <div className="flex flex-col justify-between items-center w-11/12 sm:w-10/12 lg:w-9/12 max-w-5xl mx-auto rounded-lg mt-10 min-h-[36rem] h-auto text-center bg-white shadow-lg">
